...
const playerUnits = [];
const botUnits = [];
const playerTower = { x: canvas.width / 2 - 25, y: canvas.height - 60, width: 50, height: 50, hp: 5000 };
const botTower = { x: canvas.width / 2 - 25, y: 10, width: 50, height: 50, hp: 5000 };
...
function draw() {
  ...
  ctx.fillStyle = 'black';
  ctx.font = '14px Arial';
  ctx.fillText(`HP: ${playerTower.hp}`, playerTower.x - 10, playerTower.y + 70);
  ctx.fillText(`HP: ${botTower.hp}`, botTower.x - 10, botTower.y - 10);
